          ...
          <div className="container-fluid" style={{ padding: "100px" }}>
            <ul className="nav bg-white border-0 ">
              <li className="nav-item">
                ...
                >
                  <span
                    className="p-1 mx-2 rounded-3 px-2  fw-bold text-white"
                    style={{
              ...
              <li className="nav-item">
                <a className="nav-link text-secondary" href="#">
                  <span className="border border-2 p-1 mx-2 rounded-3 px-2 fw-bold ">
                    2
                  </span>
                  Check Out
                </a>
              ...
              <li className="nav-item ">
                <a className="nav-link text-secondary" href="#">
                  <span className="border border-2 p-1 mx-2 rounded-3 px-2 fw-bold text-secondary">
                    3
                  </span>
                  Review
                </a>
